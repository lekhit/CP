...
public class Template {
    ...
    static int[] getPosArray(int[] arr){
    ...
    static void solve() throws IOException {
        ...
        int n = in.nextInt();
        int[] arr=readArray(n);
        int[] posArr = getPosArray(arr);
        int count=1;
        for(int i=2;i<n;i++){
            if(posArr[i-1]>posArr[i]) count++;
        }
        out.println(count);
    ...
    public static void main(String[] args) throws IOException {
        if (isLocalEnvironment()) {
            in = new FastReader(new FileInputStream("/Users/lekhitborole/CP/CSES/sorting-and-searching/Collecting Numbers II/input.txt"));
            out = new PrintWriter(new FileOutputStream("/Users/lekhitborole/CP/CSES/sorting-and-searching/Collecting Numbers II/output.txt"));
        } else {
